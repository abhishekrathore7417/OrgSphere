...
const IcMail = cls => <Ic cls={cls}
                          d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6"/>;
const IcPhone = cls => <Ic cls={cls}
                           d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.27 9.76 19.79 19.79 0 01.21 1.2 2 2 0 012.22 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.09a16 16 0 006 6l.56-.56a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/>;
const IcBuilding = cls => <Ic cls={cls}
                              d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>;
const IcUsers = cls => <Ic cls={cls}
...
const IcCalendar = cls => <Ic cls={cls}
                              d="M8 2v4M16 2v4M3 10h18M21 14V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h7"/>;
...
const IcLinkedin = cls => <Ic cls={cls}
                              d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6z M2 9h4v12H2z M4 4a2 2 0 110 4 2 2 0 010-4z"/>;
const IcTwitter = cls => <Ic cls={cls}
                             d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"/>;
const IcGithub = cls => <Ic cls={cls}
...
const SERVICES = [
    {
        icon: IcUsers,
        title: 'Employee & Student Management',
        desc: 'Complete profiles, roles, departments and classroom records in one place.'
    },
    {
        icon: IcClock,
        title: 'Attendance Tracking',
        desc: 'Daily attendance for employees and students with check-in/out history.'
    },
    {
        icon: IcCalendar,
        title: 'Leave Management',
        desc: 'Apply, approve and track leave requests digitally — no paperwork.'
    },
    {
        icon: IcCard,
        title: 'Payroll & Fee Management',
        desc: 'Employee salary records and student fee collection with payment history.'
    },
    {
        icon: IcGrid,
        title: 'Department & Classroom Setup',
        desc: 'Organize teams, departments and school classrooms with a tree view.'
    },
    {
        icon: IcTrend,
        title: 'Real-time Analytics',
        desc: 'Auto-refreshing dashboards, KPI charts and recent activity feeds.'
    },
];
...
const FAQS = [
    {
        q: 'What is OrgSphere?',
        a: 'OrgSphere is a complete SaaS management platform for companies and schools — employee/student management, attendance, fees, leaves and payroll, all in one place.'
    },
    {q: 'Is there a free trial?', a: 'Yes — 7 days free with every feature unlocked. No credit card required.'},
    {
        q: 'Can I manage both a company and a school?',
        a: 'Yes. One account supports multiple organization types — each with its own portal, roles and data.'
    },
    {
        q: 'Is my data secure?',
        a: 'We use JWT authentication, role-based access control and encrypted storage. Your data is fully isolated per organization.'
    },
    {
        q: 'How do I get started?',
        a: 'Click "Get Started", choose your organization type (Company or School), register and you\'re live in under 2 minutes.'
    },
];
...
// Register modal close karte waqt bhi plan reset karo
    const closeRegModal = () => {
        setRegOpen(false);
        setSelectedPlan(null);
    };
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 antialiased"
            ...
            <div className="sticky top-0 z-50">
                ...
                <div className="hidden md:flex items-center gap-4 text-white text-xs py-1"
                     style={{background: TOPBAR_NAVY}}>
                    <span
                        className="shrink-0 flex items-center gap-1 font-bold px-2.5 py-0.5 text-[11px] rounded-full ml-4"
                ...
                <nav className={`bg-white transition-shadow duration-300 ${scrolled ? 'shadow-md' : 'shadow-sm'}`}>
                        ...
                        <div className="flex items-center justify-between h-[72px] gap-6">
                            ...
                            <div className="hidden md:flex items-center gap-3">
                                <button aria-label="Search"
                                        className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:border-slate-300 transition-colors">
                                    {IcSearch('w-4 h-4')}
                                </button>
                                <Link to="/login"
                                      className="text-sm font-bold text-slate-600 px-2 hover:text-red-600 transition-colors">Sign
                                    In</Link>
                                <BtnPrimary onClick={() => setPlanOpen(true)}>Register</BtnPrimary>
                    ...
                    {navOpen && (
                        <div
                            className="lg:hidden bg-white border-t border-slate-100 px-4 py-4 flex flex-col gap-3 shadow-lg">
                            {NAV.map(l => <a key={l.href} href={l.href}
                            ...
                            <Link to="/login" onClick={() => setNavOpen(false)}
                                  className="text-sm font-semibold text-slate-600">Sign In</Link>
                            <BtnPrimary onClick={() => {
                                setPlanOpen(true);
                                setNavOpen(false);
                            }} className="w-full">Register</BtnPrimary>
                        </div>
                    )}
                </nav>

                {/* UPDATES ticker — with borders for visibility */}
                <div className={`overflow-hidden updates-row ${scrolled ? 'is-hidden' : ''}`}
                     style={{background: NAVY}}>
                    <div className="flex items-stretch">
                        <div className="shrink-0 flex items-center gap-1.5 text-[11px] font-black text-white px-2.5"
                             style={{background: RED}}>
            ...
            <section id="home" className="relative overflow-hidden" style={{background: NAVY, minHeight: '560px'}}>
                ...
                <div
                    className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col lg:flex-row items-center gap-12">
                    <div className="flex-1 text-white au">
                        ...
                        <p className="text-slate-300 text-base leading-relaxed mb-8 max-w-xl">
                            Manage employees, students, attendance, fees, payroll and leaves — all from a single
                            dashboard. Built for companies, schools and every organization in between.
                        </p>
                        <div className="flex flex-col gap-2 mb-8">
                            <div className="flex flex-wrap gap-2">
                                {['Employee Management', 'School Portal', 'Attendance Tracking'].map(b => (
                                    <span key={b}
                                          className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1 rounded-full border text-slate-200"
                                          style={{
                        ...
                        <div className="flex flex-wrap gap-3">
                            <BtnPrimary onClick={() => setPlanOpen(true)} className="text-xs px-5 py-2.5">
                                {IcArrow('w-4 h-4')} Apply Now
                            </BtnPrimary>
                            <BtnBlue onClick={() => setPlanOpen(true)} className="text-xs px-5 py-2.5">
                    ...
                    <div className="au w-full lg:w-96 shrink-0" style={{animationDelay: '.15s'}}>
                        <div className="rounded-2xl p-6 sm:p-7"
                            ...
                            <div className="mt-6 pt-5 grid grid-cols-2 sm:grid-cols-4 gap-2.5"
                                 style={{borderTop: '1px solid rgba(255,255,255,0.1)'}}>
                                {TRUST_BADGES.map(b => (
                                    <div key={b} className="text-center rounded-lg py-2.5 px-1"
            ...
            <section id="about" className="py-14 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                        <div className="au">
                            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{color: RED}}>ABOUT
                                ORGSPHERE</p>
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                OrgSphere is a unified SaaS platform designed to eliminate the complexity of managing
                                organizations. Whether you run a <strong>company with departments and
                                employees</strong> or a <strong>school with classrooms, teachers and students</strong> —
                                we've built one platform for all of it.
                            </p>
                            <p className="text-slate-600 leading-relaxed mb-6">
                                From attendance tracking and leave management to payroll, fee collection and real-time
                                analytics — every feature is crafted for the way modern organizations actually work.
                            </p>
                            <div className="flex flex-wrap gap-6">
                                {[{n: '500+', l: 'Organizations'}, {n: '10K+', l: 'Users'}, {
                                    n: '2',
                                    l: 'Portals'
                                }].map(s => (
                                    <div key={s.l}>
                                    ...
                                    return (
                                        <div key={t.title} className="border rounded-xl overflow-hidden transition-all"
                                            ...
                                            <button onClick={() => setActiveTab(i)}
                                                ...
                                                <span
                                                    className={`font-bold text-sm ${open ? 'text-white' : 'text-slate-700'}`}>{t.title}</span>
            ...
            <section id="features" className="py-14 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-black text-slate-900 mb-3" style={{letterSpacing: '-0.02em'}}>Our
                            Services</h2>
                        <p className="text-slate-500 max-w-xl mx-auto">Enterprise-class solutions tailored for
                            companies, schools and all growing organizations.</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {SERVICES.map((s, i) => (
                            <div key={s.title}
                                 className="service-card au bg-white rounded-xl p-5 text-center shadow-sm border border-slate-100 cursor-default"
                                 style={{animationDelay: `${i * 0.07}s`}}>
                                <div className="w-11 h-11 rounded-xl flex items-center justify-center mx-auto mb-3"
                                     style={{background: '#fdf1f0'}}>
            ...
            <section className="py-14 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="au">
                            <div
                                className="flex items-center justify-between mb-4 px-5 py-3 rounded-t-xl text-white font-bold text-sm"
                                style={{background: RED}}>
                                <span className="flex items-center gap-2">{IcBell('w-4 h-4')} Latest Updates</span>
                                <button className="text-xs text-red-100 hover:text-white font-semibold">View All →
                                </button>
                            </div>
                            <div
                                className="border border-t-0 border-slate-100 rounded-b-xl divide-y divide-slate-100 overflow-hidden">
                                {NOTICES.map((n, i) => (
                                    <div key={i}
                                ...
                                <div className="px-5 py-3 text-center">
                                    <button className="text-sm font-semibold hover:underline" style={{color: RED}}>View
                                        All Updates →
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="au" style={{animationDelay: '.1s'}}>
                            <div
                                className="flex items-center gap-2 mb-4 px-5 py-3 rounded-t-xl text-white font-bold text-sm"
                                style={{background: NAVY}}>
                                ...
                                {[
                                    {
                                        ...
                                        desc: 'JWT auth, role-based access, encrypted storage for every organization.'
                                    },
                                    {
                                        icon: IcTrend,
                                        title: 'Real-time Analytics',
                                        desc: 'Auto-refreshing dashboards, charts and activity feeds.'
                                    },
                                    {
                                        icon: IcUsers,
                                        title: 'Multi-Portal System',
                                        desc: 'Company portal + School portal — both under one account.'
                                    },
                                    {
                                        icon: IcGrid,
                                        title: 'Scales with You',
                                        desc: 'Handles 10 to 10,000 users — no config changes needed.'
                                    },
                                ].map(w => (
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-9">
                        <h2 className="text-3xl font-black text-slate-900 mb-3"
                            style={{letterSpacing: '-0.02em'}}>Simple Pricing</h2>
                        <p className="text-slate-500">Start free. No hidden fees. Cancel anytime.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
                        {PLANS.map((p, i) => (
                            <div key={p.name}
                                 className={`au rounded-2xl p-5 flex flex-col transition-all hover:-translate-y-1 ${p.hot ? 'text-white shadow-xl' : 'bg-white border border-slate-100 shadow-sm hover:shadow-md'}`}
                                 style={{
                                     ...(p.hot ? {
                                         background: NAVY,
                                         boxShadow: '0 16px 40px rgba(26,43,60,0.3)'
                                     } : {}), animationDelay: `${i * 0.08}s`
                                 }}>
                                {p.hot && <span
                                    className="self-start text-[10px] font-black px-2.5 py-0.5 rounded-full mb-2.5"
                                    style={{background: RED, color: 'white'}}>Most Popular</span>}
                                <p className={`text-xs font-bold uppercase tracking-wide mb-1 ${p.hot ? 'text-blue-300' : 'text-slate-500'}`}>{p.name}</p>
                                <div className="flex items-end gap-1 mb-0.5">
                                    <span
                                        className={`text-3xl font-black ${p.hot ? 'text-white' : 'text-slate-900'}`}>{p.price}</span>
                                </div>
            ...
            <section className="py-14 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-9">
                        <h2 className="text-3xl font-black text-slate-900 mb-3"
                            style={{letterSpacing: '-0.02em'}}>Frequently Asked Questions</h2>
                    </div>
                    <div className="space-y-2">
                        {FAQS.map((f, i) => {
            ...
            <section className="py-10" style={{background: NAVY}}>
                <div className="max-w-3xl mx-auto px-4 text-center">
                    ...
                    <p className="text-slate-300 mb-8">Join 500+ companies and schools using OrgSphere. Free 7-day
                        trial, no card needed.</p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <BtnPrimary onClick={() => setPlanOpen(true)} className="px-6 py-3 text-xs">
                            {IcArrow('w-4 h-4')} Get Started Free
                        </BtnPrimary>
                        <BtnBlue onClick={() => setPlanOpen(true)} className="px-6 py-3 text-xs">
                            Book a Demo
                        </BtnBlue>
                    </div>
                </div>
            ...
            <div className="py-6 px-4" style={{background: RED}}>
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        <button onClick={() => setPlanOpen(true)}
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-md text-xs font-bold bg-white transition-all hover:opacity-90"
                                style={{color: RED}}>
                            {IcArrow('w-4 h-4')} Get Started
                        </button>
                        <button onClick={() => setPlanOpen(true)}
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-md text-xs font-bold text-white border-2 border-white/40 hover:bg-white/10 transition-all">
                            Contact Sales
                        </button>
                    </div>
                </div>
            ...
            <footer id="contact" style={{background: NAVY}}>
                            ...
                            <div className="flex gap-2 mt-5">
                                {[IcLinkedin, IcTwitter, IcGithub].map((ic, i) => (
                                    <a key={i} href="#contact"
                                       className="w-9 h-9 rounded-lg flex items-center justify-center bg-slate-800 hover:bg-red-600 text-slate-400 hover:text-white transition-all">
                                        {ic('w-4 h-4')}
                                    </a>
                                ))}
                            </div>
                        ...
                        {FOOTER_COLS.map(col => (
                            <div key={col.title}>
                                ...
                                <ul className="space-y-2.5">
                                    {col.links.map(l => (
                                        <li key={l}><a href="#contact"
                                                       className="text-sm text-slate-400 hover:text-red-400 transition-colors">{l}</a>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                ...
                <div className="border-t py-5" style={{borderColor: 'rgba(255,255,255,0.06)'}}>
                    <div
                        ...
                        <p className="text-xs text-slate-500">© 2026 OrgSphere. All rights reserved. Made for
                            companies &amp; schools.</p>
            ...
            {planOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white w-full max-w-3xl shadow-2xl"
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Select a plan to continue registration
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="p-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {PLANS.map((p) => (
                                <button key={p.name}
                                        ...
                                        className={`flex flex-col rounded-xl p-5 text-left border-2 transition-all hover:-translate-y-1 hover:shadow-lg ${
                                            p.hot
                                                ? 'text-white border-transparent'
                                                : 'bg-white border-slate-100 hover:border-red-400'
                                        }`}
                                        style={ p.hot ? { background: NAVY } : {} }>

                                    {p.hot && (
                                        <span className="self-start text-[10px] font-black px-2.5 py-0.5 rounded-full mb-3"
                                              style={{ background: RED, color: 'white' }}>
                                Most Popular
                            </span>
                                    )}
                                    <p className={`text-xs font-bold uppercase tracking-wide mb-1 ${
                                        p.hot ? 'text-blue-300' : 'text-slate-500'
                                    }`}>{p.name}</p>
                                    <div className="flex items-end gap-1 mb-0.5">
                            <span className={`text-3xl font-black ${
                                p.hot ? 'text-white' : 'text-slate-900'
                            }`}>{p.price}</span>
                                    </div>
                                    <p className={`text-xs mb-4 ${
                                        p.hot ? 'text-blue-200' : 'text-slate-400'
                                    }`}>{p.sub}</p>
                                    <ul className="space-y-1.5 flex-1 mb-5">
                                        {p.items.map(f => (
                                            <li key={f} className="flex items-center gap-2 text-xs">
                                                {IcCheck(`w-3.5 h-3.5 shrink-0 ${
                                                    p.hot ? 'text-blue-300' : 'text-red-600'
                                                }`)}
                                                <span className={
                                                    p.hot ? 'text-blue-100' : 'text-slate-600'
                                                }>{f}</span>
                                            </li>
                                        ))}
                                    </ul>
                                    <div className={`w-full py-2.5 rounded-lg text-xs font-black text-center transition-all ${
                                        p.hot
                        ...
                        <p className="text-center text-xs text-slate-400 pb-5">
                            ...
                            <Link to="/login" onClick={() => setPlanOpen(false)}
                                  className="font-bold hover:underline" style={{ color: RED }}>
                                Sign In
                            </Link>
                        </p>
                    </div>
            ...
            {regOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white w-full max-w-sm p-8" style={{borderTop: `4px solid ${RED}`}}>
                        ...
                        <div className="mb-7">
                            ...
                            {selectedPlan && (
                                <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold"
                                    ...
                                    Plan: {selectedPlan}
                                    <button onClick={() => { setRegOpen(false); setPlanOpen(true); }}
                        ...
                        <button onClick={() => {
                            navigate('/register/company', {state: {plan: selectedPlan}});
                            setRegOpen(false);
                        }}
                            ...
                            <span className="w-10 h-10 flex items-center justify-center shrink-0"
                                  style={{background: '#f7f5f0', color: NAVY}}>
                                {IcBuilding('w-5 h-5')}
                            </span>
                        ...
                        <p className="text-center text-sm mt-5 text-slate-500">
                            Already have an account?{' '}
                            <Link to="/login" onClick={() => setRegOpen(false)} className="font-bold hover:underline"
                                  style={{color: RED_D}}>Sign In</Link>
                        </p>
                    </div>
                </div>
            )}
