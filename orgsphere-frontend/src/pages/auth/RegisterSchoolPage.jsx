            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-[2rem] shadow-2xl p-8 md:p-10 border border-gray-100">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Register School</h1>
                        <p className="text-sm text-gray-500 mt-2">Create your school account</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-3">
                        <div className="relative">
                            <FaSchool className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={14} />
                            <input
