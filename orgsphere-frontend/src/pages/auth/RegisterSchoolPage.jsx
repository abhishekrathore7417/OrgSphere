...
/* ── Reusable field wrapper — same as company ───────────── */
...
const RegisterSchoolPage = () => {
    ...
    /* lock body scroll — same as company */
    useEffect(() => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const data = res.data;
            if (data.token) {
                toast.success('✅ School registered successfully!', { autoClose: 1500 });
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-3xl max-h-[92vh] overflow-y-auto shadow-2xl"
                ...
                {/* Form — same 2-column grid structure as company */}
                <div className="px-6 py-5">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

                            {/* Left column — Organisation Info */}
