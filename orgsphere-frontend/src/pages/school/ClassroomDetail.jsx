...
const ClassroomDetail = () => {
    ...
    const tabs = [
        { label: 'Students',   path: `/school/classrooms/${classroomId}/students`,   desc: 'Manage enrolled students' },
        { label: 'Attendance', path: `/school/classrooms/${classroomId}/attendance`, desc: 'Mark student attendance' },
        { label: 'Fees',       path: `/school/classrooms/${classroomId}/fees`,       desc: 'Track and collect fees' },
        { label: 'Leaves',     path: `/school/classrooms/${classroomId}/leaves`,     desc: 'Manage student leaves' },
    ];
        ...
        <SchoolLayout>
            <div className="p-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
                    <button onClick={() => navigate('/school/classrooms')} className="hover:text-violet-600 transition-colors">
                        Classrooms
                    </button>
                    ...
                    <span className="text-gray-700 font-medium">Classroom #{classroomId}</span>
                </div>
                ...
                <div className="bg-violet-600 rounded-xl p-6 text-white mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">Classroom #{classroomId}</h2>
                            <p className="text-violet-200 text-sm mt-0.5">Classroom Overview</p>
                        </div>
                    </div>
                </div>
